...
// if (now>50000 && now<135000)
// {
//     ofstream outfile;
//     outfile.open("AttitudeAngle0923.csv", ios::out | ios::app);
// 	outfile<<euler_roll_angle <<","<<_euler_angle_target.x<<","<<euler_pitch_angle <<","<<_euler_angle_target.y<<","<<euler_yaw_rate * _dt <<","<<_euler_angle_target.z<<endl;
// 	outfile.close();
// }
...
// //      if (now>45000 && now<85000)
// // {
// //     ofstream outfile;
// //     outfile.open("AttitudeAngle0908.csv", ios::out | ios::app);
// // 	outfile<<euler_roll_angle <<","<<_euler_angle_target.x<<","<<euler_pitch_angle <<","<<_euler_angle_target.y<<","<<euler_yaw_angle <<","<<_euler_angle_target.z<<endl;
// // 	outfile.close();
// //  }
...
<<<<<<< HEAD
    ...
    _attitude_target.to_euler(_euler_angle_target);
=======
    // calculate the attitude xtarget euler angles
...
void AC_AttitudeControl::thrust_vector_rotation_angles(const Quaternion& attitude_target, const Quaternion& attitude_body, Quaternion& thrust_vector_correction, Vector3f& attitude_error, float& thrust_angle, float& thrust_error_angle) const
{
    ...
    // Rotating [0,0,-1] by atxtitude_target expresses (gets a view of) the target thrust vector in the inertial frame
   ...
   // printf("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
//       uint64_t now =AP_HAL::millis();
//      if (now>45000 && now<93000)
// {
//     ofstream outfile;
//     outfile.open("AttitudeAngle1029.csv", ios::out | ios::app);
// 	outfile<<rotation.x<<","<<rotation.y<<","<<rotation.z<<endl;
// 	outfile.close();
//  }
}
